...
let put_container ~config ~db ~id ~host ~message data =
...
let delete_container ~config ~db ~id ~message =
  Model.delete_container ~db ~container_id:id ~message

let post_annotation ~config ~db ~container_id ~annotation_id ~host ~message data
    =
...
let put_annotation ~config ~db ~container_id ~annotation_id ~host ~message data
    =
...
let container_exists ~config ~db ~id =
  Model.container_exists ~db ~container_id:id

let annotation_exists ~config ~db ~container_id ~annotation_id =
...
let get_collection_hash ~config ~db ~id =
  Model.get_collection_hash ~db ~container_id:id

let get_container_hash ~config ~db ~id =
  Model.get_container_hash ~db ~container_id:id

let get_annotation_hash ~config ~db ~container_id ~annotation_id =
  Model.get_annotation_hash ~db ~container_id ~annotation_id

let get_annotation ~config ~db ~container_id ~annotation_id =
  Model.get_annotation ~db ~container_id ~annotation_id
  >|= Annotation.annotation

let delete_annotation ~config ~db ~container_id ~annotation_id ~message =
  Model.delete_annotation ~db ~container_id ~annotation_id ~message

let get_manifest ~config ~db ~id =
  Model.get_manifest ~db ~manifest_id:id >|= Manifest.manifest

let post_manifest ~config ~db ~id ~message data =
...
let put_manifest ~config ~db ~id ~message data =
...
let delete_manifest ~config ~db ~id ~message =
  Model.delete_manifest ~db ~manifest_id:id ~message

let manifest_exists ~config ~db ~id = Model.manifest_exists ~db ~manifest_id:id

let get_manifest_hash ~config ~db ~id =
