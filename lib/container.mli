...
val add_annotation : db:Db.t -> key:string list -> json:Ezjsonm.value -> message:string -> unit Lwt.t

val update_annotation : db:Db.t -> key:string list -> json:Ezjsonm.value -> message:string -> unit Lwt.t
