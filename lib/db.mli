...
val add : ctx:t -> key:string list -> json:Ezjsonm.value -> message:string -> unit Lwt.t
...
val get_collection : ctx:t -> key:string list -> offset:int -> length:int -> Ezjsonm.value Lwt.t
